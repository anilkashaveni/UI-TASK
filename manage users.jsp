...
<form name="myform" action="add details.jsp" method="post" onsubmit="return validateform()">
	 <table style="margin-right:5px;margin-top:30px;width:80%" border=0 cellSpacing=0 cellPadding=1>
...
<td style="width:8%"><a href="edit details.jsp?email=<%=s3%>" ><input type="button" value="Edit" name="edit"></a></td>  
...
<input size=30 type=text maxlength=10 name="sid">
</font>
</td>
</tr>
<tr>
...
<td align=right width=127 height=42>
<input size=30 type=text maxlength=30 name="sname">
</font>
</td>
</tr>
<tr>
...
<td align=right width=127 height=42>
<input size=30 type=text maxlength=30 name="email">
</font>
</td>
</tr>
<tr>
...
<td align=right width=127 height=42>
<input size=30 type=text maxlength=10 name="class">
</font>
</td>
</tr>
<tr>
...
<td align=right width=127 height=42>
<input size=30 type=text maxlength=10 name="enrollyear">
</font>
</td>
</tr>			
<tr>
...
<td align=right width=127 height=42>
<input size=30 type=text maxlength=20  name="city">
</td>
</tr>
<tr>
<td  align=left width=192 height=42><font size=3 color="black">Country</td>
<td align=right width=127 height=42>
<input size=30 type=text maxlength=20  name="country">
</td>
</tr>               
<tr>
